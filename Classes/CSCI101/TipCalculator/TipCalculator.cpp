...
int main() {
  ...
  cout << "Tax (6.75%): $" << roundToDecimalPlace(mealCharge * 0.0675, 2)
       << endl;
  cout << "Tip (" << tipPercentage * 100 << "%): $"
       << roundToDecimalPlace(mealCharge * tipPercentage, 2) << endl;
  cout << "Total Cost: $"
       << roundToDecimalPlace(
              mealCharge + mealCharge * tipPercentage + mealCharge * 0.0675, 2)
       << endl;
}